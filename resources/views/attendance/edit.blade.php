    ...
    <div class="card" style="max-width: 600px; margin: 0 auto;">
        <form method="POST" action="{{ route('attendance.update', $attendance) }}" style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div>
                ...
                <input type="date" id="date" name="date" value="{{ old('date', $attendance->attendance_date->format('Y-m-d')) }}" required style="width: 100%; padding: 10px; border: 2px solid #e5e7eb; border-radius: 6px;">
