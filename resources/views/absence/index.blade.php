    ...
    <div class="card" style="max-width: 700px; margin: 0 auto;">
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 30px; padding: 15px; background: #f5f5f5; border-radius: 6px;">
            <div style="flex: 1; text-align: center;">
                <div style="width: 40px; height: 40px; background: #3b82f6; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 8px; font-weight: 600;" id="step1-icon">1</div>
        ...
        <div id="step1-container" style="margin-bottom: 30px; padding: 20px; border: 3px solid #3b82f6; border-radius: 8px; background: #fafafa;">
            ...
            <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #eee;">
                <form id="manual-form" style="display: flex; gap: 10px;">
                    ...
                    <button type="submit" class="btn" style="padding: 10px 15px; white-space: nowrap;">Enter</button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        function validateAndSetQRCode(code) {
            ...
            setTimeout(() => {
                ...
                step2Icon.style.background = '#3b82f6';
            ...
            canvas.toBlob(blob => {
                ...
                reader.onload = function(e) {
                    ...
                    setTimeout(() => {
                        ...
                        step3Icon.style.background = '#3b82f6';
